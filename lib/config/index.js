...
var deprecate = require('depd')('npd');
...
Config.prototype._load = function (name, opts) {
    ...
    Object.defineProperty(this, "prefix", {
        get: function () {
            ...
            if (config.dir) {
                deprecate('dir setting in npd config/options');
                return config.dir;
            }
    ...
    Object.defineProperty(this, "dir", {
        get: function () {
            ...
            return path.resolve(that.prefix);
        },
        set: function (value) {
            throw new Error('Don\'t setting dir, using prefix');
        },
        enumerable: true
    });
    ...
    Object.defineProperty(this, "globalDir", {
        get: function () {
            return path.resolve(that.prefix, that.apps);
        },
        enumerable: true
    });
