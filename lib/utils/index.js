...
exports.supportDirs = function (npd, app) {
    return exports.genDirs(npd, ['etc', 'var', 'log'], app);
};

exports.genDirs = function (npd) {
    var dirs, i, j, arg, arr;
    if (Array.isArray(npd)) {
        dirs = npd;
    } else if (typeof npd === 'string') {
        dirs = [npd];
    } else if (npd) {
        dirs = [npd.config.get('root') || '/'];
    } else {
