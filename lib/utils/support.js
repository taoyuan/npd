...
exports.dirSupports = function (sorb, app) {
    return exports.dirs(sorb, ['etc', 'var', 'log'], app);
};

exports.dirs = function (sorb) {
    var dirs, i, j, arg, arr;
    if (Array.isArray(sorb)) {
        dirs = sorb;
    } else if (typeof sorb === 'string') {
        dirs = [sorb];
    } else if (sorb) {
        dirs = [sorb.config.get('root')];
    } else {
